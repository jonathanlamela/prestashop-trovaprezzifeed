...
use TrovaprezziFeed\Form\Type\ProductBlacklistType as Type;
...
class ProductBlacklistController extends PrestaShopAdminController
{
    ...
    public const CREATE_ROUTE = 'trovaprezzifeed_product_blacklist_create';
    public const DELETE_ROUTE = 'trovaprezzifeed_product_blacklist_delete';
